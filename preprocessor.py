...
if __name__ == '__main__':
    ...
    # remove "early access review" review from text, add new column
    df_reviews_all = remove_early_access(df_reviews_all)
    ...
    df_reviews_all["review_text"] = df_reviews_all["review_text"].str.strip(
    ).str.lower()
